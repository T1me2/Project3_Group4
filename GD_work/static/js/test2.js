function showSchoolMarkersCounty(state, county='') {
    ...
    // }
    // else {
    //   let countyQuery = `%20AND%20NMCNTY%20%3D%20'${county} County'`;
    //   console.log(countyQuery);
    // }

    console.log("Inside showschoolmarkers",state,countyQuery);
    ...
    // let stateQuery = `query?where=LSTATE%20%3D%20'${state}'${countyQuery}%20AND%20OBJECTID>${firstIndex}&&outFields=*&outSR=4326&f=json`;
    // let stateQueryOffset = `query?where=LSTATE%20%3D%20'${state}'${countyQuery}&resultOffset=${offsetCount}&outFields=*&outSR=4326&f=json`;
